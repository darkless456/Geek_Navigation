    ...
    $('#submit').click(function(e) {
        ...
        $('#apply').ajaxSubmit({
            ...
            success: function(data, status) {
                $('#container').html('<h2>感谢你的贡献</h2><p>提交的内容正在确认，稍后会以邮件形式通知你。</p><p>已提交内容</p><p class="site">网站名称：' + data.site + '</p><p class="url">网站地址：' + data.url + '</p><p class="intro">网站简介：' + data.intro + '</p><p class="email">联系邮箱：' + data.email + '</p><p = class="uptime">提交时间：' + data.uptime + '</p>');
            }
        })
    })
